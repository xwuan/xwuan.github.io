...
- **[Feature] Universal Twemoji Integration**: Implemented Twemoji across all pages via <script src="https://cdn.jsdelivr.net/npm/@twemoji/api@14.1.0/dist/twemoji.min.js"></script>. Emojis are parsed into crisp SVG images on load (	wemoji.parse(document.body)), ensuring consistent rendering across all devices and eliminating the blurry emoji issue on Windows.